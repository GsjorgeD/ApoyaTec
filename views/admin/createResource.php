...
$userController->headPages('Agregar recursos');
...
<main class="main">
    ...
    <section>
        ...
        <div class="s-to-center s-center">
            <form action="../../scripts/createResourceBD.php" method="post">
            <input type="hidden" value="<?php echo $course->id ?>" name="idCurso">
                <div class="s-mb-4">
                    <label>Nombre del recurso</label>
                    <input type="text" class="input input-text" name="txtName" placeholder="Nombre" style="width: 500px;">
                </div>
                <div class="s-mb-4">
                    <label>Link del recurso</label>
                    <input type="text" class="input input-text" name="txtLink" placeholder="Link" style="width: 500px;">
                </div>
