...
$user->headPages('Actualizar clase');
...
<main class="main">
    <div class="ed-grid s-grid-2">
        <div>
            ...
            <form action="../../scripts/editClassBD.php" method="post">
                ...
                <input type="hidden" value="<?php echo $idClase ?>" name="idClase">

                <label class="label-input">Nombre
                    <input type="text" class="input" placeholder="Nombre" value="<?php echo $datosClase->name ?>" name="txtNombre" required>
                </label>
                <label class="label-input">URL del video
                    <input type="text" class="input" placeholder="Url del video" value="<?php echo $datosClase->urlVideo ?>" name="txtURL" required>
                </label>
                <div class="ed-grid s-grid-2">
                    <label class="label-input">Duración
                        <input type="text" class="input" placeholder="Duración" value="<?php echo $datosClase->duration ?>" name="txtDuracion" pattern="[0-9]{2}:[0-9]{2}:[0-9]{2}" required>
                    </label>
                    <label class="label-input">View
                        <input type="text" class="input" readonly value="<?php echo $datosClase->views ?>" name="txtVistas">
                    </label>
                </div>
                <label class="label-input ">Notas
                    <textarea class="input-text" name="txtNotas" required id="" cols="30" rows="10" placeholder="Agrega aqui notas extras"><?php echo $datosClase->notes ?></textarea>
                </label>

                <div class="ed-grid s-grid-2">
                    <label class="label-input ">Mover de la posicion
                        <input type="number" class="input s-mr-4 " name="posicionOriginal" value="<?php echo $datosClase->_index; ?>" readonly>
                    </label>
                    <label class="label-input ">a la posición
                        <select class="input s-px-05 s-right" name="posicionNueva" id="">
                            <option value=""></option>
                            <?php
