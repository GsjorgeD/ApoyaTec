...
$userController->headPages('Actualizar recursos');
...
<main class="main">
    ...
    <section>
        ...
        <div class="s-to-center s-center">
            <form action="../../scripts/editResourceBD.php" method="post">
            <input type="hidden" value="<?php echo $course->id ?>" name="idCurso">
            <input type="hidden" value="<?php echo $resource->id ?>" name="idRecurso">
                <div class="s-mb-4">
                    <label>Nombre del recurso</label>
                    <input type="text" class="input input-text" name="txtName" placeholder="Nombre" style="width: 500px;" value="<?php echo $resource->name?>" required>
                </div>
                <div class="s-mb-4">
                    <label>Link del recurso</label>
                    <input type="text" class="input input-text" name="txtLink" placeholder="Link" style="width: 500px;" value="<?php echo $resource->urlResource?>" required>
                </div>
